...
def load_model(TESTING_MODEL):
    ...
    if TESTING_MODEL == "Flamingo":
        from baselines.openflamingo_modeling import VLLMFlamingo
        ...
        from baselines.minigpt4_modeling import VLLMMiniGPT4
        ...
        from baselines.llava_modeling import VLLMLLaVA
        ...
        from baselines.llama_adapter_v2_modeling import VLLMLlamaAdapterV2
        ...
        from baselines.instruct_blip_modeling import VLLMInstructBLIP2
